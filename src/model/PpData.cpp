...
void PpData::setCommunicationCharacteristics(CommunicationCharacteristics const& value)
{
...
void PpData::setExpectedUeBehaviourParameters(ExpectedUeBehaviour const& value)
{
