...
void PduSessionManagementData::setPduSessionStatus(PduSessionStatus const& value)
{
...
std::vector<RouteToLocation>& PduSessionManagementData::getN6TrafficRoutingInfo()
{
    return m_N6TrafficRoutingInfo;
}
void PduSessionManagementData::setN6TrafficRoutingInfo(std::vector<RouteToLocation> const& value)
{
...
void PduSessionManagementData::setIpv6Prefix(std::vector<Ipv6Prefix> const& value)
{
    m_Ipv6Prefix = value;
...
void PduSessionManagementData::setIpv6Addrs(std::vector<Ipv6Addr> const& value)
{
    m_Ipv6Addrs = value;
