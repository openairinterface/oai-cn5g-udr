...
void UnrelatedClass::setDefaultUnrelatedClass(DefaultUnrelatedClass const& value)
{
...
void UnrelatedClass::setExternalUnrelatedClass(ExternalUnrelatedClass const& value)
{
...
std::vector<ServiceTypeUnrelatedClass>& UnrelatedClass::getServiceTypeUnrelatedClasses()
{
    return m_ServiceTypeUnrelatedClasses;
}
void UnrelatedClass::setServiceTypeUnrelatedClasses(std::vector<ServiceTypeUnrelatedClass> const& value)
{
