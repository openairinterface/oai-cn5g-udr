...
void AmfNon3GppAccessRegistration::setAmfServiceNameDereg(ServiceName const& value)
{
...
void AmfNon3GppAccessRegistration::setAmfServiceNamePcscfRest(ServiceName const& value)
{
