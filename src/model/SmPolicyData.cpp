...
std::map<std::string, SmPolicySnssaiData>& SmPolicyData::getSmPolicySnssaiData()
{
    return m_SmPolicySnssaiData;
}
void SmPolicyData::setSmPolicySnssaiData(std::map<std::string, SmPolicySnssaiData> const& value)
{
...
void SmPolicyData::setUmDataLimits(std::map<std::string, UsageMonDataLimit> const& value)
{
