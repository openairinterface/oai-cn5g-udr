...
void AfExternal::setAllowedGeographicArea(std::vector<GeographicArea> const& value)
{
...
void AfExternal::setPrivacyCheckRelatedAction(PrivacyCheckRelatedAction const& value)
{
