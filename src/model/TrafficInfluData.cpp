...
void TrafficInfluData::setEthTrafficFilters(std::vector<EthFlowDescription> const& value)
{
...
void TrafficInfluData::setTrafficRoutes(std::vector<RouteToLocation> const& value)
{
...
void TrafficInfluData::setTempValidities(std::vector<TemporalValidity> const& value)
{
...
void TrafficInfluData::setSubscribedEvents(std::vector<SubscribedEvent> const& value)
{
