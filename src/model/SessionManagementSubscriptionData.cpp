...
std::map<std::string, DnnConfiguration>& SessionManagementSubscriptionData::getDnnConfigurations()
{
    return m_DnnConfigurations;
}
void SessionManagementSubscriptionData::setDnnConfigurations(std::map<std::string, DnnConfiguration> const& value)
{
...
std::vector<std::string>& SessionManagementSubscriptionData::getInternalGroupIds()
{
...
std::map<std::string, std::string>& SessionManagementSubscriptionData::getSharedVnGroupDataIds()
{
...
OdbPacketServices SessionManagementSubscriptionData::getOdbPacketServices() const
{
    return m_OdbPacketServices;
}
void SessionManagementSubscriptionData::setOdbPacketServices(OdbPacketServices const& value)
{
...
std::map<std::string, ExpectedUeBehaviourData>& SessionManagementSubscriptionData::getExpectedUeBehavioursList()
{
    return m_ExpectedUeBehavioursList;
}
void SessionManagementSubscriptionData::setExpectedUeBehavioursList(std::map<std::string, ExpectedUeBehaviourData> const& value)
{
...
std::map<std::string, SuggestedPacketNumDl>& SessionManagementSubscriptionData::getSuggestedPacketNumDlList()
{
    return m_SuggestedPacketNumDlList;
}
void SessionManagementSubscriptionData::setSuggestedPacketNumDlList(std::map<std::string, SuggestedPacketNumDl> const& value)
{
