...
void ApplicationDataChangeNotif::setIptvConfigData(IptvConfigData const& value)
{
...
void ApplicationDataChangeNotif::setPfdData(PfdChangeNotification const& value)
{
    m_PfdData = value;
    m_PfdDataIsSet = true;
}
...
void ApplicationDataChangeNotif::setSerParamData(ServiceParameterData const& value)
{
