...
std::vector<GeographicArea>& LcsClientGroupExternal::getAllowedGeographicArea()
{
    return m_AllowedGeographicArea;
}
void LcsClientGroupExternal::setAllowedGeographicArea(std::vector<GeographicArea> const& value)
{
...
PrivacyCheckRelatedAction LcsClientGroupExternal::getPrivacyCheckRelatedAction() const
{
    return m_PrivacyCheckRelatedAction;
}
void LcsClientGroupExternal::setPrivacyCheckRelatedAction(PrivacyCheckRelatedAction const& value)
{
