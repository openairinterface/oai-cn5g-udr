...
void DataChangeNotify::setOriginalCallbackReference(std::vector<std::string> const& value)
{
...
std::vector<SdmSubscription>& DataChangeNotify::getAdditionalSdmSubscriptions()
{
    return m_AdditionalSdmSubscriptions;
}
void DataChangeNotify::setAdditionalSdmSubscriptions(std::vector<SdmSubscription> const& value)
{
...
std::vector<SubscriptionDataSubscriptions>& DataChangeNotify::getSubscriptionDataSubscriptions()
{
    return m_SubscriptionDataSubscriptions;
}
void DataChangeNotify::setSubscriptionDataSubscriptions(std::vector<SubscriptionDataSubscriptions> const& value)
{
