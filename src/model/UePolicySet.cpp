...
void UePolicySet::setPraInfos(std::map<std::string, PresenceInfo> const& value)
{
    m_PraInfos = value;
...
void UePolicySet::setUePolicySections(std::map<std::string, UePolicySection> const& value)
{
...
std::map<std::string, PlmnRouteSelectionDescriptor>& UePolicySet::getAllowedRouteSelDescs()
{
    return m_AllowedRouteSelDescs;
}
void UePolicySet::setAllowedRouteSelDescs(std::map<std::string, PlmnRouteSelectionDescriptor> const& value)
{
