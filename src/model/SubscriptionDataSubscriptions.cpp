...
std::vector<std::string>& SubscriptionDataSubscriptions::getMonitoredResourceUris()
{
...
void SubscriptionDataSubscriptions::setSdmSubscription(SdmSubscription const& value)
{
