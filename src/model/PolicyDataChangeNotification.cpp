...
void PolicyDataChangeNotification::setPlmnUePolicySet(UePolicySet const& value)
{
...
SponsorConnectivityData PolicyDataChangeNotification::getSponsorConnectivityData() const
{
    return m_SponsorConnectivityData;
}
void PolicyDataChangeNotification::setSponsorConnectivityData(SponsorConnectivityData const& value)
{
...
OperatorSpecificDataContainer PolicyDataChangeNotification::getOpSpecData() const
{
    return m_OpSpecData;
}
void PolicyDataChangeNotification::setOpSpecData(OperatorSpecificDataContainer const& value)
{
    m_OpSpecData = value;
...
std::map<std::string, OperatorSpecificDataContainer>& PolicyDataChangeNotification::getOpSpecDataMap()
{
    return m_OpSpecDataMap;
}
void PolicyDataChangeNotification::setOpSpecDataMap(std::map<std::string, OperatorSpecificDataContainer> const& value)
{
...
std::vector<NotificationItem>& PolicyDataChangeNotification::getReportedFragments()
{
    return m_ReportedFragments;
}
void PolicyDataChangeNotification::setReportedFragments(std::vector<NotificationItem> const& value)
{
