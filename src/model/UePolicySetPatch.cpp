...
std::map<std::string, UePolicySection>& UePolicySetPatch::getUePolicySections()
{
    return m_UePolicySections;
}
void UePolicySetPatch::setUePolicySections(std::map<std::string, UePolicySection> const& value)
{
