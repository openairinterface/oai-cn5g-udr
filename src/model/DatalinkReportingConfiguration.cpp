...
std::vector<DddTrafficDescriptor>& DatalinkReportingConfiguration::getDddTrafficDes()
{
    return m_DddTrafficDes;
}
void DatalinkReportingConfiguration::setDddTrafficDes(std::vector<DddTrafficDescriptor> const& value)
{
...
std::vector<DlDataDeliveryStatus>& DatalinkReportingConfiguration::getDddStatusList()
{
    return m_DddStatusList;
}
void DatalinkReportingConfiguration::setDddStatusList(std::vector<DlDataDeliveryStatus> const& value)
{
