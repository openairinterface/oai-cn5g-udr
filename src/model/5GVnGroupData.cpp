...
void _5GVnGroupData::setPduSessionTypes(std::vector<PduSessionType> const& value)
{
...
void _5GVnGroupData::setAppDescriptors(std::vector<AppDescriptor> const& value)
{
