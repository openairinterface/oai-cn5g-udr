...
void TrafficInfluDataPatch::setEthTrafficFilters(std::vector<EthFlowDescription> const& value)
{
...
void TrafficInfluDataPatch::setTrafficFilters(std::vector<FlowInfo> const& value)
{
...
void TrafficInfluDataPatch::setTrafficRoutes(std::vector<RouteToLocation> const& value)
{
...
void TrafficInfluDataPatch::setTempValidities(std::vector<TemporalValidity> const& value)
{
