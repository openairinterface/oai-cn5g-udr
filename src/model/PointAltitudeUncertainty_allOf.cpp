...
void PointAltitudeUncertainty_allOf::setPoint(GeographicalCoordinates const& value)
{
    m_Point = value;
}
...
UncertaintyEllipse PointAltitudeUncertainty_allOf::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointAltitudeUncertainty_allOf::setUncertaintyEllipse(UncertaintyEllipse const& value)
{
