...
std::map<std::string, MonitoringConfiguration>& EeSubscription::getMonitoringConfigurations()
{
    return m_MonitoringConfigurations;
}
void EeSubscription::setMonitoringConfigurations(std::map<std::string, MonitoringConfiguration> const& value)
{
