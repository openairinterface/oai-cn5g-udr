...
void DefaultUnrelatedClass::setAllowedGeographicArea(std::vector<GeographicArea> const& value)
{
...
PrivacyCheckRelatedAction DefaultUnrelatedClass::getPrivacyCheckRelatedAction() const
{
    return m_PrivacyCheckRelatedAction;
}
void DefaultUnrelatedClass::setPrivacyCheckRelatedAction(PrivacyCheckRelatedAction const& value)
{
