...
void ContextDataSets::setSdmSubscriptions(std::vector<SdmSubscription> const& value)
{
...
void ContextDataSets::setEeSubscriptions(std::vector<EeSubscription> const& value)
{
...
std::vector<SubscriptionDataSubscriptions>& ContextDataSets::getSubscriptionDataSubscriptions()
{
    return m_SubscriptionDataSubscriptions;
}
void ContextDataSets::setSubscriptionDataSubscriptions(std::vector<SubscriptionDataSubscriptions> const& value)
{
...
void ContextDataSets::setSmfRegistrations(std::vector<SmfRegistration> const& value)
{
