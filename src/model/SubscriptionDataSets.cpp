...
void SubscriptionDataSets::setAmData(AccessAndMobilitySubscriptionData const& value)
{
    m_AmData = value;
    m_AmDataIsSet = true;
}
...
void SubscriptionDataSets::setSmfSelData(SmfSelectionSubscriptionData const& value)
{
    m_SmfSelData = value;
...
std::vector<SessionManagementSubscriptionData>& SubscriptionDataSets::getSmData()
{
    return m_SmData;
}
void SubscriptionDataSets::setSmData(std::vector<SessionManagementSubscriptionData> const& value)
{
    m_SmData = value;
    m_SmDataIsSet = true;
}
...
void SubscriptionDataSets::setSmsMngData(SmsManagementSubscriptionData const& value)
{
    m_SmsMngData = value;
...
LcsBroadcastAssistanceTypesData SubscriptionDataSets::getLcsBroadcastAssistanceTypesData() const
{
    return m_LcsBroadcastAssistanceTypesData;
}
void SubscriptionDataSets::setLcsBroadcastAssistanceTypesData(LcsBroadcastAssistanceTypesData const& value)
{
