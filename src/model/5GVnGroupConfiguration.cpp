...
void _5GVnGroupConfiguration::setMembers(std::vector<std::string> const& value)
{
    m_Members = value;
    m_MembersIsSet = true;
}
...
void _5GVnGroupConfiguration::setInternalGroupIdentifier(std::string const& value)
{
...
void _5GVnGroupConfiguration::setMtcProviderInformation(std::string const& value)
{
