...
std::vector<std::string>& LcsBroadcastAssistanceTypesData::getLocationAssistanceType()
{
    return m_LocationAssistanceType;
}
void LcsBroadcastAssistanceTypesData::setLocationAssistanceType(std::vector<std::string> const& value)
{
