...
std::vector<SnssaiRouteSelectionDescriptor>& PlmnRouteSelectionDescriptor::getSnssaiRouteSelDescs()
{
    return m_SnssaiRouteSelDescs;
}
void PlmnRouteSelectionDescriptor::setSnssaiRouteSelDescs(std::vector<SnssaiRouteSelectionDescriptor> const& value)
{
