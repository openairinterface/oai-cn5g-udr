...
private:
    ...
    void get_odb_data_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void query_odb_data_by_supi_or_gpsi_document_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    virtual void get_odb_data(const std::string &ueId, Pistache::Http::ResponseWriter &response) = 0;
