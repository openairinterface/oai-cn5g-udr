...
public:
    SMSManagementSubscriptionDataDocumentApi(std::shared_ptr<Pistache::Rest::Router>);
...
private:
    ...
    void query_sms_mng_data_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void sms_management_subscription_data_document_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
