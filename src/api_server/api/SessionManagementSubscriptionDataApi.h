...
private:
    ...
    void query_sm_data_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void session_management_subscription_data_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    /// <param name="singleNssai">single NSSAI (optional, default to Snssai())</param>
    /// <param name="dnn">DNN (optional, default to &quot;&quot;)</param>
