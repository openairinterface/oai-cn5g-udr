...
public:
    LCSBroadcastAssistanceSubscriptionDataApi(std::shared_ptr<Pistache::Rest::Router>);
...
private:
    ...
    void query_lcs_bca_data_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void lcs_broadcast_assistance_subscription_data_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
