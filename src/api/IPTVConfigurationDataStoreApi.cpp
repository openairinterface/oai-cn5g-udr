...
IPTVConfigurationDataStoreApi::IPTVConfigurationDataStoreApi(std::shared_ptr<Pistache::Rest::Router> rtr) { 
    router = rtr;
}
...
void IPTVConfigurationDataStoreApi::setupRoutes() {
    ...
    Routes::Get(*router, base + "/application-data/iptvConfigData", Routes::bind(&IPTVConfigurationDataStoreApi::read_iptv_congifuration_data_handler, this));

    // Default handler, called when a route is not found
    router->addCustomHandler(Routes::bind(&IPTVConfigurationDataStoreApi::iptv_configuration_data_store_api_default_handler, this));
}

void IPTVConfigurationDataStoreApi::read_iptv_congifuration_data_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
...
//        }
    ...
    try {
      this->read_iptv_congifuration_data(configIds, dnns, snssais, supis, interGroupIds, response);
...
void IPTVConfigurationDataStoreApi::iptv_configuration_data_store_api_default_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
