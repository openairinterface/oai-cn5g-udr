...
AccessAndMobilitySubscriptionDataDocumentApiImpl::AccessAndMobilitySubscriptionDataDocumentApiImpl(std::shared_ptr<Pistache::Rest::Router> rtr , MYSQL *mysql)
    ...
    if(row != NULL)
    {
        for (int i = 0; field = mysql_fetch_field(res); i++)
        {
            ...
            else if(!strcmp("sharedVnGroupDataIds", field->name) && row[i] != NULL)
            {
                ...
                accessandmobilitysubscriptiondata.setSharedVnGroupDataIds(sharedvngroupdataids);
            }
            ...
            else if(!strcmp("serviceAreaRestriction", field->name) && row[i] != NULL)
            {
            ...
            else if(!strcmp("coreNetworkTypeRestrictions", field->name) && row[i] != NULL)
            {
                std :: vector < CoreNetworkType > corenetworktyperestrictions;
                nlohmann::json::parse(row[i]).get_to(corenetworktyperestrictions);
                accessandmobilitysubscriptiondata.setCoreNetworkTypeRestrictions(corenetworktyperestrictions);
            }
            ...
            else if(!strcmp("sorUpdateIndicatorList", field->name) && row[i] != NULL)
            {
                std :: vector < SorUpdateIndicator > sorupdateindicatorlist;
                nlohmann::json::parse(row[i]).get_to(sorupdateindicatorlist);
                accessandmobilitysubscriptiondata.setSorUpdateIndicatorList(sorupdateindicatorlist);
            }
            ...
            else if(!strcmp("odbPacketServices", field->name) && row[i] != NULL)
            {
                ...
                accessandmobilitysubscriptiondata.setOdbPacketServices(odbpacketservices);
            }
            ...
            else if(!strcmp("nssaiInclusionAllowed", field->name) && row[i] != NULL)
            {
                if(strcmp(row[i], "0"))
            ...
            else if(!strcmp("rgWirelineCharacteristics", field->name) && row[i] != NULL)
            {
                accessandmobilitysubscriptiondata.setRgWirelineCharacteristics(row[i]);
            }
            else if(!strcmp("ecRestrictionDataWb", field->name) && row[i] != NULL)
            {
                EcRestrictionDataWb ecrestrictiondatawb;
                nlohmann::json::parse(row[i]).get_to(ecrestrictiondatawb);
                accessandmobilitysubscriptiondata.setEcRestrictionDataWb(ecrestrictiondatawb);
            }
            else if(!strcmp("ecRestrictionDataNb", field->name) && row[i] != NULL)
            {
                if(strcmp(row[i], "0"))
            ...
            else if(!strcmp("expectedUeBehaviourList", field->name) && row[i] != NULL)
            {
                ExpectedUeBehaviourData expecteduebehaviourlist;
                nlohmann::json::parse(row[i]).get_to(expecteduebehaviourlist);
                accessandmobilitysubscriptiondata.setExpectedUeBehaviourList(expecteduebehaviourlist);
            }
            else if(!strcmp("primaryRatRestrictions", field->name) && row[i] != NULL)
            {
                std :: vector < RatType > primaryratrestrictions;
                nlohmann::json::parse(row[i]).get_to(primaryratrestrictions);
                accessandmobilitysubscriptiondata.setPrimaryRatRestrictions(primaryratrestrictions);
            }
            else if(!strcmp("secondaryRatRestrictions", field->name) && row[i] != NULL)
            {
                std :: vector < RatType > secondaryratrestrictions;
                nlohmann::json::parse(row[i]).get_to(secondaryratrestrictions);
                accessandmobilitysubscriptiondata.setSecondaryRatRestrictions(secondaryratrestrictions);
            }
            else if(!strcmp("edrxParametersList", field->name) && row[i] != NULL)
            {
                ...
                accessandmobilitysubscriptiondata.setEdrxParametersList(edrxparameterslist);
            }
            else if(!strcmp("ptwParametersList", field->name) && row[i] != NULL)
            {
                ...
                accessandmobilitysubscriptiondata.setPtwParametersList(ptwparameterslist);
            }
            else if(!strcmp("iabOperationAllowed", field->name) && row[i] != NULL)
            {
                if(strcmp(row[i], "0"))
            ...
            else if(!strcmp("wirelineForbiddenAreas", field->name) && row[i] != NULL)
            {
                std :: vector < WirelineArea > wirelineforbiddenareas;
                nlohmann::json::parse(row[i]).get_to(wirelineforbiddenareas);
                accessandmobilitysubscriptiondata.setWirelineForbiddenAreas(wirelineforbiddenareas);
            }
            else if(!strcmp("wirelineServiceAreaRestriction", field->name) && row[i] != NULL)
            {
                ...
                accessandmobilitysubscriptiondata.setWirelineServiceAreaRestriction(wirelineservicearearestriction);
            }
        }
