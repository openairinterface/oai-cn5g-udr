...
SMSManagementSubscriptionDataDocumentApiImpl::SMSManagementSubscriptionDataDocumentApiImpl(std::shared_ptr<Pistache::Rest::Router> rtr)
    : SMSManagementSubscriptionDataDocumentApi(rtr)
    { }

void SMSManagementSubscriptionDataDocumentApiImpl::query_sms_mng_data(const std::string &ueId, const std::string &servingPlmnId, const Pistache::Optional<std::string> &supportedFeatures, const Pistache::Optional<Pistache::Http::Header::Raw> &ifNoneMatch, const Pistache::Optional<Pistache::Http::Header::Raw> &ifModifiedSince, Pistache::Http::ResponseWriter &response) {
