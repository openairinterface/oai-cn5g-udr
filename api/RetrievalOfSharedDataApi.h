...
private:
    ...
    virtual void get_shared_data(const Pistache::Optional<Set<std::string>> &sharedDataIds, const Pistache::Optional<std::string> &supportedFeatures, Pistache::Http::ResponseWriter &response) = 0;
