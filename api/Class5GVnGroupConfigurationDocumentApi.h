...
private:
    ...
    virtual void create5_g_vn_group(const std::string &externalGroupId, const 5GVnGroupConfiguration &r_5GVnGroupConfiguration, Pistache::Http::ResponseWriter &response) = 0;
