...
void DnnRouteSelectionDescriptor::setSscModes(std::vector<SscMode> const& value)
{
    m_SscModes = value;
...
void DnnRouteSelectionDescriptor::setPduSessTypes(std::vector<PduSessionType> const& value)
{
