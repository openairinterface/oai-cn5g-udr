...
std::string SorInfo::getSorTransparentContainer() const
{
    return m_SorTransparentContainer;
}
void SorInfo::setSorTransparentContainer(std::string const& value)
{
    m_SorTransparentContainer = value;
    m_SorTransparentContainerIsSet = true;
}
bool SorInfo::sorTransparentContainerIsSet() const
{
    return m_SorTransparentContainerIsSet;
}
void SorInfo::unsetSorTransparentContainer()
{
    m_SorTransparentContainerIsSet = false;
}
