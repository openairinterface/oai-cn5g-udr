...
Object TrafficInfluData::getDnn() const
{
    return m_Dnn;
}
void TrafficInfluData::setDnn(Object const& value)
{
    m_Dnn = value;
    m_DnnIsSet = true;
}
...
std::vector<Object>& TrafficInfluData::getEthTrafficFilters()
{
    return m_EthTrafficFilters;
}
void TrafficInfluData::setEthTrafficFilters(std::vector<Object> const& value)
{
...
Object TrafficInfluData::getSnssai() const
{
    return m_Snssai;
}
void TrafficInfluData::setSnssai(Object const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
Object TrafficInfluData::getInterGroupId() const
{
    return m_InterGroupId;
}
void TrafficInfluData::setInterGroupId(Object const& value)
{
...
Object TrafficInfluData::getSupi() const
{
    return m_Supi;
}
void TrafficInfluData::setSupi(Object const& value)
{
    m_Supi = value;
    m_SupiIsSet = true;
}
...
std::vector<Object>& TrafficInfluData::getTrafficFilters()
{
    return m_TrafficFilters;
}
void TrafficInfluData::setTrafficFilters(std::vector<Object> const& value)
{
...
std::vector<Object>& TrafficInfluData::getTrafficRoutes()
{
    return m_TrafficRoutes;
}
void TrafficInfluData::setTrafficRoutes(std::vector<Object> const& value)
{
...
Object TrafficInfluData::getValidStartTime() const
{
    return m_ValidStartTime;
}
void TrafficInfluData::setValidStartTime(Object const& value)
{
...
Object TrafficInfluData::getValidEndTime() const
{
    return m_ValidEndTime;
}
void TrafficInfluData::setValidEndTime(Object const& value)
{
...
std::vector<Object>& TrafficInfluData::getTempValidities()
{
    return m_TempValidities;
}
void TrafficInfluData::setTempValidities(std::vector<Object> const& value)
{
...
Object TrafficInfluData::getNwAreaInfo() const
{
    return m_NwAreaInfo;
}
void TrafficInfluData::setNwAreaInfo(Object const& value)
{
    m_NwAreaInfo = value;
...
Object TrafficInfluData::getUpPathChgNotifUri() const
{
    return m_UpPathChgNotifUri;
}
void TrafficInfluData::setUpPathChgNotifUri(Object const& value)
{
...
std::vector<Object>& TrafficInfluData::getSubscribedEvents()
{
    return m_SubscribedEvents;
}
void TrafficInfluData::setSubscribedEvents(std::vector<Object> const& value)
{
...
Object TrafficInfluData::getDnaiChgType() const
{
    return m_DnaiChgType;
}
void TrafficInfluData::setDnaiChgType(Object const& value)
{
    m_DnaiChgType = value;
...
Object TrafficInfluData::getSupportedFeatures() const
{
    return m_SupportedFeatures;
}
void TrafficInfluData::setSupportedFeatures(Object const& value)
{
...
Object TrafficInfluData::getResUri() const
{
    return m_ResUri;
}
void TrafficInfluData::setResUri(Object const& value)
{
    m_ResUri = value;
    m_ResUriIsSet = true;
}
