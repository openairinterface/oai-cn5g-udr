...
void SharedData::setSharedDnnConfigurations(std::map<std::string, DnnConfiguration> const& value)
{
...
void SharedData::setSharedSnssaiInfos(std::map<std::string, SnssaiInfo> const& value)
{
...
void SharedData::setSharedVnGroupDatas(std::map<std::string, VnGroupData> const& value)
{
...
std::map<std::string, SharedDataTreatmentInstruction>& SharedData::getTreatmentInstructions()
{
    return m_TreatmentInstructions;
}
void SharedData::setTreatmentInstructions(std::map<std::string, SharedDataTreatmentInstruction> const& value)
{
