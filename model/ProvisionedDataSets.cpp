...
void ProvisionedDataSets::setAmData(AccessAndMobilitySubscriptionData const& value)
{
    m_AmData = value;
    m_AmDataIsSet = true;
}
...
void ProvisionedDataSets::setSmfSelData(SmfSelectionSubscriptionData const& value)
{
    m_SmfSelData = value;
...
std::vector<SessionManagementSubscriptionData>& ProvisionedDataSets::getSmData()
{
    return m_SmData;
}
void ProvisionedDataSets::setSmData(std::vector<SessionManagementSubscriptionData> const& value)
{
    m_SmData = value;
    m_SmDataIsSet = true;
}
...
void ProvisionedDataSets::setSmsMngData(SmsManagementSubscriptionData const& value)
{
    m_SmsMngData = value;
...
void ProvisionedDataSets::setLcsBcaData(LcsBroadcastAssistanceTypesData const& value)
{
    m_LcsBcaData = value;
