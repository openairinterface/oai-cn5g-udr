...
void DnnConfiguration::setPduSessionContinuityInd(PduSessionContinuityInd const& value)
{
...
void DnnConfiguration::setIpv4FrameRouteList(std::vector<FrameRouteInfo> const& value)
{
...
void DnnConfiguration::setIpv6FrameRouteList(std::vector<FrameRouteInfo> const& value)
{
