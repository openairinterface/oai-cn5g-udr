...
std::vector<Object>& TrafficInfluSub::getDnns()
{
    return m_Dnns;
}
void TrafficInfluSub::setDnns(std::vector<Object> const& value)
{
    m_Dnns = value;
    m_DnnsIsSet = true;
}
...
std::vector<Object>& TrafficInfluSub::getSnssais()
{
    return m_Snssais;
}
void TrafficInfluSub::setSnssais(std::vector<Object> const& value)
{
    m_Snssais = value;
    m_SnssaisIsSet = true;
}
...
std::vector<Object>& TrafficInfluSub::getInternalGroupIds()
{
    return m_InternalGroupIds;
}
void TrafficInfluSub::setInternalGroupIds(std::vector<Object> const& value)
{
...
std::vector<Object>& TrafficInfluSub::getSupis()
{
    return m_Supis;
}
void TrafficInfluSub::setSupis(std::vector<Object> const& value)
{
    m_Supis = value;
    m_SupisIsSet = true;
}
...
Object TrafficInfluSub::getNotificationUri() const
{
    return m_NotificationUri;
}
void TrafficInfluSub::setNotificationUri(Object const& value)
{
    m_NotificationUri = value;
}
Object TrafficInfluSub::getExpiry() const
{
    return m_Expiry;
}
void TrafficInfluSub::setExpiry(Object const& value)
{
    m_Expiry = value;
    m_ExpiryIsSet = true;
}
...
Object TrafficInfluSub::getSupportedFeatures() const
{
    return m_SupportedFeatures;
}
void TrafficInfluSub::setSupportedFeatures(Object const& value)
{
