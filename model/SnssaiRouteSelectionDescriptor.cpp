...
std::vector<DnnRouteSelectionDescriptor>& SnssaiRouteSelectionDescriptor::getDnnRouteSelDescs()
{
    return m_DnnRouteSelDescs;
}
void SnssaiRouteSelectionDescriptor::setDnnRouteSelDescs(std::vector<DnnRouteSelectionDescriptor> const& value)
{
