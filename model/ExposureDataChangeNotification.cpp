...
Object ExposureDataChangeNotification::getUeId() const
{
    return m_UeId;
}
void ExposureDataChangeNotification::setUeId(Object const& value)
{
    m_UeId = value;
    m_UeIdIsSet = true;
}
...
Object ExposureDataChangeNotification::getAccessAndMobilityData() const
{
    return m_AccessAndMobilityData;
}
void ExposureDataChangeNotification::setAccessAndMobilityData(Object const& value)
{
...
std::vector<PduSessionManagementData>& ExposureDataChangeNotification::getPduSessionManagementData()
{
    return m_PduSessionManagementData;
}
void ExposureDataChangeNotification::setPduSessionManagementData(std::vector<PduSessionManagementData> const& value)
{
...
std::vector<Object>& ExposureDataChangeNotification::getDelResources()
{
    return m_DelResources;
}
void ExposureDataChangeNotification::setDelResources(std::vector<Object> const& value)
{
