...
OneOfstringintegernumberbooleanobject OperatorSpecificDataContainer::getValue() const
{
    return m_Value;
}
void OperatorSpecificDataContainer::setValue(OneOfstringintegernumberbooleanobject const& value)
{
    m_Value = value;
}
