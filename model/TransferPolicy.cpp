...
Object TransferPolicy::getMaxBitRateDl() const
{
    return m_MaxBitRateDl;
}
void TransferPolicy::setMaxBitRateDl(Object const& value)
{
...
Object TransferPolicy::getMaxBitRateUl() const
{
    return m_MaxBitRateUl;
}
void TransferPolicy::setMaxBitRateUl(Object const& value)
{
...
Object TransferPolicy::getRecTimeInt() const
{
    return m_RecTimeInt;
}
void TransferPolicy::setRecTimeInt(Object const& value)
{
    m_RecTimeInt = value;
}
