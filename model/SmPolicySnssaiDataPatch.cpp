...
std::map<std::string, SmPolicyDnnDataPatch>& SmPolicySnssaiDataPatch::getSmPolicyDnnData()
{
    return m_SmPolicyDnnData;
}
void SmPolicySnssaiDataPatch::setSmPolicyDnnData(std::map<std::string, SmPolicyDnnDataPatch> const& value)
{
