...
Object MdtConfiguration::getJobType() const
{
    return m_JobType;
}
void MdtConfiguration::setJobType(Object const& value)
{
    m_JobType = value;
}
Object MdtConfiguration::getReportType() const
{
    return m_ReportType;
}
void MdtConfiguration::setReportType(Object const& value)
{
    m_ReportType = value;
...
Object MdtConfiguration::getAreaScope() const
{
    return m_AreaScope;
}
void MdtConfiguration::setAreaScope(Object const& value)
{
    m_AreaScope = value;
...
void MdtConfiguration::setMeasurementLteList(std::vector<MeasurementLteForMdt> const& value)
{
...
void MdtConfiguration::setMeasurementNrList(std::vector<MeasurementNrForMdt> const& value)
{
...
void MdtConfiguration::setSensorMeasurementList(std::vector<SensorMeasurement> const& value)
{
...
void MdtConfiguration::setReportingTriggerList(std::vector<ReportingTrigger> const& value)
{
...
Object MdtConfiguration::getReportInterval() const
{
    return m_ReportInterval;
}
void MdtConfiguration::setReportInterval(Object const& value)
{
...
Object MdtConfiguration::getReportIntervalNr() const
{
    return m_ReportIntervalNr;
}
void MdtConfiguration::setReportIntervalNr(Object const& value)
{
...
Object MdtConfiguration::getReportAmount() const
{
    return m_ReportAmount;
}
void MdtConfiguration::setReportAmount(Object const& value)
{
...
Object MdtConfiguration::getLoggingInterval() const
{
    return m_LoggingInterval;
}
void MdtConfiguration::setLoggingInterval(Object const& value)
{
...
Object MdtConfiguration::getLoggingIntervalNr() const
{
    return m_LoggingIntervalNr;
}
void MdtConfiguration::setLoggingIntervalNr(Object const& value)
{
...
Object MdtConfiguration::getLoggingDuration() const
{
    return m_LoggingDuration;
}
void MdtConfiguration::setLoggingDuration(Object const& value)
{
...
Object MdtConfiguration::getLoggingDurationNr() const
{
    return m_LoggingDurationNr;
}
void MdtConfiguration::setLoggingDurationNr(Object const& value)
{
...
Object MdtConfiguration::getPositioningMethod() const
{
    return m_PositioningMethod;
}
void MdtConfiguration::setPositioningMethod(Object const& value)
{
...
Object MdtConfiguration::getCollectionPeriodRmmLte() const
{
    return m_CollectionPeriodRmmLte;
}
void MdtConfiguration::setCollectionPeriodRmmLte(Object const& value)
{
...
Object MdtConfiguration::getCollectionPeriodRmmNr() const
{
    return m_CollectionPeriodRmmNr;
}
void MdtConfiguration::setCollectionPeriodRmmNr(Object const& value)
{
...
Object MdtConfiguration::getMeasurementPeriodLte() const
{
    return m_MeasurementPeriodLte;
}
void MdtConfiguration::setMeasurementPeriodLte(Object const& value)
{
...
void MdtConfiguration::setMdtAllowedPlmnIdList(std::vector<PlmnId> const& value)
{
...
void MdtConfiguration::setInterFreqTargetList(std::vector<InterFreqTargetInfo> const& value)
{
