...
std::map<std::string, LimitIdToMonitoringKey>& SmPolicyDnnData::getRefUmDataLimitIds()
{
    return m_RefUmDataLimitIds;
}
void SmPolicyDnnData::setRefUmDataLimitIds(std::map<std::string, LimitIdToMonitoringKey> const& value)
{
...
void SmPolicyDnnData::setPraInfos(std::map<std::string, PresenceInfo> const& value)
{
    m_PraInfos = value;
