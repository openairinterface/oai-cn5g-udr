...
std::vector<Object>& NetworkAreaInfo_2::getEcgis()
{
    return m_Ecgis;
}
void NetworkAreaInfo_2::setEcgis(std::vector<Object> const& value)
{
    m_Ecgis = value;
    m_EcgisIsSet = true;
}
...
std::vector<Object>& NetworkAreaInfo_2::getNcgis()
{
    return m_Ncgis;
}
void NetworkAreaInfo_2::setNcgis(std::vector<Object> const& value)
{
    m_Ncgis = value;
    m_NcgisIsSet = true;
}
...
std::vector<Object>& NetworkAreaInfo_2::getGRanNodeIds()
{
    return m_GRanNodeIds;
}
void NetworkAreaInfo_2::setGRanNodeIds(std::vector<Object> const& value)
{
    m_GRanNodeIds = value;
...
std::vector<Object>& NetworkAreaInfo_2::getTais()
{
    return m_Tais;
}
void NetworkAreaInfo_2::setTais(std::vector<Object> const& value)
{
    m_Tais = value;
    m_TaisIsSet = true;
}
