...
Snssai SmPolicySnssaiData::getSnssai() const
{
    return m_Snssai;
}
void SmPolicySnssaiData::setSnssai(Snssai const& value)
{
    m_Snssai = value;
}
std::map<std::string, SmPolicyDnnData>& SmPolicySnssaiData::getSmPolicyDnnData()
{
    return m_SmPolicyDnnData;
}
void SmPolicySnssaiData::setSmPolicyDnnData(std::map<std::string, SmPolicyDnnData> const& value)
{
