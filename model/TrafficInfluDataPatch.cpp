...
Object TrafficInfluDataPatch::getDnn() const
{
    return m_Dnn;
}
void TrafficInfluDataPatch::setDnn(Object const& value)
{
    m_Dnn = value;
    m_DnnIsSet = true;
}
...
std::vector<Object>& TrafficInfluDataPatch::getEthTrafficFilters()
{
    return m_EthTrafficFilters;
}
void TrafficInfluDataPatch::setEthTrafficFilters(std::vector<Object> const& value)
{
...
Object TrafficInfluDataPatch::getSnssai() const
{
    return m_Snssai;
}
void TrafficInfluDataPatch::setSnssai(Object const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
Object TrafficInfluDataPatch::getInternalGroupId() const
{
    return m_InternalGroupId;
}
void TrafficInfluDataPatch::setInternalGroupId(Object const& value)
{
...
Object TrafficInfluDataPatch::getSupi() const
{
    return m_Supi;
}
void TrafficInfluDataPatch::setSupi(Object const& value)
{
    m_Supi = value;
    m_SupiIsSet = true;
}
...
std::vector<Object>& TrafficInfluDataPatch::getTrafficFilters()
{
    return m_TrafficFilters;
}
void TrafficInfluDataPatch::setTrafficFilters(std::vector<Object> const& value)
{
...
std::vector<Object>& TrafficInfluDataPatch::getTrafficRoutes()
{
    return m_TrafficRoutes;
}
void TrafficInfluDataPatch::setTrafficRoutes(std::vector<Object> const& value)
{
...
Object TrafficInfluDataPatch::getValidStartTime() const
{
    return m_ValidStartTime;
}
void TrafficInfluDataPatch::setValidStartTime(Object const& value)
{
...
Object TrafficInfluDataPatch::getValidEndTime() const
{
    return m_ValidEndTime;
}
void TrafficInfluDataPatch::setValidEndTime(Object const& value)
{
...
std::vector<Object>& TrafficInfluDataPatch::getTempValidities()
{
    return m_TempValidities;
}
void TrafficInfluDataPatch::setTempValidities(std::vector<Object> const& value)
{
...
Object TrafficInfluDataPatch::getNwAreaInfo() const
{
    return m_NwAreaInfo;
}
void TrafficInfluDataPatch::setNwAreaInfo(Object const& value)
{
    m_NwAreaInfo = value;
...
Object TrafficInfluDataPatch::getUpPathChgNotifUri() const
{
    return m_UpPathChgNotifUri;
}
void TrafficInfluDataPatch::setUpPathChgNotifUri(Object const& value)
{
