...
Object WirelineServiceAreaRestriction::getRestrictionType() const
{
    return m_RestrictionType;
}
void WirelineServiceAreaRestriction::setRestrictionType(Object const& value)
{
...
void WirelineServiceAreaRestriction::setAreas(std::vector<WirelineArea> const& value)
{
    m_Areas = value;
    m_AreasIsSet = true;
}
