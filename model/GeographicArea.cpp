...
Object GeographicArea::getShape() const
{
    return m_Shape;
}
void GeographicArea::setShape(Object const& value)
{
    m_Shape = value;
}
...
void GeographicArea::setPointList(std::vector<GeographicalCoordinates> const& value)
{
    m_PointList = value;
}
